...
public class GunSmithTableMenu extends AbstractContainerMenu {
    public static final MenuType<GunSmithTableMenu> TYPE = IMenuTypeExtension.create(GunSmithTableMenu::new);

    private final ResourceLocation blockId;
    private final RecipeFilter filter;

    public GunSmithTableMenu(int id, Inventory inventory, RegistryFriendlyByteBuf friendlyByteBuf) {
        super(TYPE, id);
        this.blockId = friendlyByteBuf.readResourceLocation();
    ...
    private GunSmithTableRecipe getRecipe(ResourceLocation recipeId, RecipeManager recipeManager) {
        ...
        if (recipe != null && recipe.value() instanceof GunSmithTableRecipe gunSmithTableRecipe) {
    ...
    public void doCraft(ResourceLocation recipeId, Player player) {
        ...
        var handler = player.getCapability(Capabilities.ItemHandler.ENTITY, null);
